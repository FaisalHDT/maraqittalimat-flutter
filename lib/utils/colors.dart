...
class AppColors {
  ...
  static final Color bgGreen = const Color.fromRGBO(232, 245, 233, 1);
  static final Color green100 = const Color(0xff81c784);
  static final Color green500 = const Color(0xff4caf50);
}
